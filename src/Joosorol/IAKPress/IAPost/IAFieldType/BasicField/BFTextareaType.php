...
class BFTextareaType extends BasicFieldTypeBase {
    const TYPE = AbstractFieldType::BF_TEXTAREA_TYPE;
    const RENDER_TYPE = AbstractFieldType::BF_TEXTAREA_RENDER_TYPE;
    const LABEL = 'Paragraph text';
