...
class ActionEmailConfirmationType extends ActionTypeBase
{
    const TYPE = FieldRenderType::ACTION_SIGN_UP_ADMIN_NOTIFICATION_TYPE;
    const RENDER_TYPE = FieldRenderType::ACTION_RENDER_TYPE;
    const LABEL = 'Email Confirmation';
