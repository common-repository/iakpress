...
class StepperButtonPreviousType extends StepperButtonTypeBase
{
    const TYPE = FieldRenderType::STEPPER_BUTTON_BTN_PREVIOUS_TYPE;
    const RENDER_TYPE = FieldRenderType::STEPPER_BUTTON_RENDER_TYPE;
    const LABEL = 'Previous Button';
    const BLOCK_NAME = 'iakpress/iakfield-prevbtn';
