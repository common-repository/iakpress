...
class ColorPaletteType extends BasicFieldTypeBase
{
    const TYPE = FieldRenderType::COLOR_PALETTE_TYPE;
    const RENDER_TYPE = FieldRenderType::COLOR_RENDER_TYPE;
    const LABEL = 'Color Palette';
    const BLOCK_NAME = 'iakpress/iakfield-colorpalette';
