...
class PTApiSmtp extends PTApiKeysConfig {
    const TYPE_VALUE = TemplateTypes::FT_SMTP_API;
    const NAME = 'smtp';
    const TITLE_TEXT = 'SMTP';
    const HELP_TEXT = 'Connect to an External Mail Server';
