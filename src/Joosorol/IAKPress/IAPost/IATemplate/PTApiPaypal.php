...
use App\Joosorol\IAKPress\IAPost\IAFieldType\ApiConfig\PaypalApiConfigType;
use App\Joosorol\IAKPress\IAPost\IAFieldType\Common\Option;

class PTApiPaypal extends PTApiKeysConfig {
    const TYPE_VALUE = TemplateTypes::FT_PAYPAL_API;
    const NAME = 'paypal';
    const TITLE_TEXT = 'Paypal';
    const HELP_TEXT = 'PayPal Checkout';
    ...
    {
        return new PaypalApiConfigType(
                self::PARAMS, 
                [
